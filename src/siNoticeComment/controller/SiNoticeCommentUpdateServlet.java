 ...
 */
@WebServlet(name = "SiNoticeCommentUpdate", urlPatterns = { "/siNoticeCommentUpdate" })
public class SiNoticeCommentUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SiNoticeCommentUpdateServlet() {
        super();
