...
/**
 * Servlet implementation class FindBoardUpdateAddionServlet
 */
@WebServlet(name = "FindBoardUpdateAddion", urlPatterns = { "/findBoardUpdateAddion" })
public class FindBoardUpdateAddionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindBoardUpdateAddionServlet() {
        super();
