...
/**
 * Servlet implementation class TakeBoardEnrollServlet
 */
@WebServlet(name = "TakeBoardEnroll", urlPatterns = { "/takeBoardEnroll" })
public class TakeBoardEnrollServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TakeBoardEnrollServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result>0 && b.getBoardType()==3) {
			...
			request.setAttribute("loc", "/takeBoard");
