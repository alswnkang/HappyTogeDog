...
@WebServlet(name = "AdminReservPage", urlPatterns = { "/adminReservPage" })
public class AdminReservPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
    public AdminReservPageServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			bp = new BookApplyService().adminReservationMypage(reqPage, startDay, endDay);
			request.setAttribute("bp", bp);
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/adoption/adminMypage.jsp");
