...
public class SiAdoptionBoardUpdateOriginalServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AdoptionBoard a = new AdoptionBoard(0,0, 0, null, adoptionBoardName, adoptionBoardTitle, adoptionBoardContent, adoptionBoardFilename, adoptionBoardFilepath, null, 0, 0, null,null);
