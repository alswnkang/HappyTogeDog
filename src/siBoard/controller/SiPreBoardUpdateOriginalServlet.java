 ...
 */
@WebServlet(name = "SiPreBoardUpdateOriginal", urlPatterns = { "/siPreBoardUpdateOriginal" })
public class SiPreBoardUpdateOriginalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SiPreBoardUpdateOriginalServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Board b = new Board(0,0, 0, null, boardName, boardTitle, boardContent, boardFilename, boardFilepath, null, 0, 0, null,null);
