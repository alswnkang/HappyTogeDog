 ...
 */
@WebServlet(name = "SiPreBoardInsert", urlPatterns = { "/siPreBoardInsert" })
public class SiPreBoardInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SiPreBoardInsertServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Board b = new Board(0,0, boardType, boardId, boardName, boardTitle, boardContent, boardFilename, boardFilepath, null, 0, 0, null,null,null,null,null);
