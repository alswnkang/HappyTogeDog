...
<section id="content-wrapper">
	<div class="area">
		...
		<div class="search-selectDate">
			<form action="/adminReservPage" method="post">
			...
			<table class="comm-tbl type2">
				<tr>
					<th>No.</th><th>보호소명</th><th>신청자 아이디</th><th>신청자 이름</th><th>신청자 전화번호</th><th>방문 날짜</th><th>방문 시간</th><th>신청 날짜</th><th>신청 상태</th>
				</tr>
...
<script>
		function view(no){
			location.href="/adminReservView?no="+no+"&startDay=${start}&endDay=${end}&reqPage=${reqPage}";
		}
</script>
